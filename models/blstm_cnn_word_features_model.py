from keras.layers import Dense, Embedding, LSTM, TimeDistributed, Conv1D, MaxPooling1D, Input, Flatten, GlobalMaxPooling1D
...
def blstm_cnn_wd_ft_ner2(max_len_sent, max_len_word, num_tags, word_embedding_dims, word_feature_embedding_dims, char_embedding_dims):
    '''
    BLSTM-CNN network with word features. 
    '''
    ##### character-level CNN ######
