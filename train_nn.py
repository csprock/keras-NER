...
feat_transformer = featureTransformer(WORDS, TAGS, tag_pad_value = 'O', zero_tag = 'O', word_padding = 'post', sent_truncating = 'post', word_truncating = 'post', sent_padding = 'post', max_len_sent = MAX_LEN_SENT, max_len_word = MAX_LEN_WORD)
